      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          >
            ...
            <p className="text-sm group-hover:text-purple-600 text-slate-600 transition-all duration-300">
              Upload Existing
            </p>
          </button>
        </div>
          ...
          {allResume.map((resume, index) => {
            ...
            return (
              <button
                ...
                className="relative w-full sm:max-w-36 h-48 flex flex-col items-centre justify-center rounded-lg gap-2 border group hover:shadow-lg transition-all duration-300 cursor-pointer"
                style={{
          ...
          >
            <div onClick={(e)=>e.stopPropagation()} className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6">
              ...
              <div>
                ...
                {/* this is for uploading a resume in pdf format */}
